    ...
    <>
        ...
        <nav className="hidden items-center gap-7 text-sm font-medium text-wine/60 sm:flex">
          ...
          {mounted && user ? (
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/mypage"
                className="inline-flex items-center gap-1.5 rounded-full border border-rose/25 bg-white px-4 py-2 font-semibold text-crimson transition-all hover:border-rose hover:shadow-soft"
              >
              ...
              <button
                type="button"
                onClick={() => logout()}
                className="text-wine/45 transition-colors hover:text-crimson"
              >
                로그아웃
              </button>
            </div>
            ...
            <>
              <button
                ...
                className="rounded-full border border-rose/25 bg-white px-4 py-2 font-semibold text-crimson transition-all hover:border-rose hover:shadow-soft"
              >
                로그인
              </button>
              <Link
      ...
      {showLogin && (
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-sm animate-modal-in rounded-3xl border border-white/40 bg-cream p-8 text-center shadow-petalHover sm:p-10">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-rose-grad text-white shadow-petal">
            ...
            <div className="mt-7 flex flex-col gap-3">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2.5 rounded-full bg-[#FEE500] px-6 py-3.5 text-sm font-bold text-[#191600] transition-all hover:brightness-95"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <button
                type="button"
                onClick={handleMockLogin}
                className="flex w-full items-center justify-center gap-2.5 rounded-full border border-rose/20 bg-white px-6 py-3.5 text-sm font-bold text-ink transition-all hover:border-rose/40 hover:shadow-soft"
              >
            ...
            <p className="mt-6 text-[11px] leading-relaxed text-wine/40">
            ...
            <button
              type="button"
              onClick={() => setShowLogin(false)}
              className="mx-auto mt-4 block text-sm font-medium text-wine/50 transition-colors hover:text-crimson"
            >
              닫기
            </button>
          </div>
