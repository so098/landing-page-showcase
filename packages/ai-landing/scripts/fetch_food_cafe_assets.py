#!/usr/bin/env python3
"""
ClipartKorea authenticated downloader for the 04-food-cafe asset pool.
...
Usage:
  python3 scripts/fetch_food_cafe_assets.py --target 40
"""
...
MANIFEST_PATH = ROOT / "04-food-cafe-manifest.json"
