#!/usr/bin/env python3
"""
ClipartKorea authenticated downloader for the 09-wedding-event-studio asset pool.
...
MANIFEST_PATH = ROOT / "09-wedding-event-studio-manifest.json"
...
def main():
    ...
    try:
        for chapter, items in plan["chapters"].items():
            if chapter != "09-wedding-event-studio":
                continue
            for item in items:
                slug = item["slug"]
