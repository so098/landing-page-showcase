#!/usr/bin/env python3
"""
ClipartKorea authenticated downloader for the 11-fitness-hobby asset pool.
...
Usage:
  python3 scripts/fetch_fitness_hobby_assets.py --target 40
"""
...
MANIFEST_PATH = ROOT / "11-fitness-hobby-manifest.json"
