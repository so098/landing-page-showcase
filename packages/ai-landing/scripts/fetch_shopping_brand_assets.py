#!/usr/bin/env python3
"""
ClipartKorea authenticated downloader for the 08-shopping-brand asset pool.
...
Usage:
  python3 scripts/fetch_shopping_brand_assets.py --target 40
"""
...
MANIFEST_PATH = ROOT / "08-shopping-brand-manifest.json"
