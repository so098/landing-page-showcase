#!/usr/bin/env python3
"""
ClipartKorea authenticated downloader for the 10-living-local-services asset pool.
...
Usage:
  python3 scripts/fetch_wedding_event_assets.py --target 40
"""
...
MANIFEST_PATH = ROOT / "10-living-local-services-manifest.json"
...
def main():
    ...
    try:
        for chapter, items in plan["chapters"].items():
            if chapter != "10-living-local-services":
                continue
            for item in items:
                slug = item["slug"]
